...
import org.jboss.weld.extensions.bean.ImmutableNarrowingBean;
import org.jboss.weld.extensions.bean.ImmutablePassivationCapableNarrowingBean;
 ...
 *
 * <p>Adopted from Weld Extensions to add support for importing an Annotated
 * instance (in addition to an AnnotatedType instance)</p>
 * 
 * @author Pete Muir
 * @see ImmutableNarrowingBean
 * @see ImmutablePassivationCapableNarrowingBean
 * @see https://jira.jboss.org/browse/WELDX-191
 */
public class NarrowingBeanBuilder<T>
{
   ...
   public NarrowingBeanBuilder<T> readFromAnnotated(Annotated annotated)
   {
      this.types = new HashSet<Type>(annotated.getTypeClosure());
