 ...
 * 
 * <p>
 * Provides a producer method that retrieves the value of the specified HTTP
 * header from {@link HttpServletRequest#getHeader(String)} and makes it
 * available as a dependent-scoped bean of type String qualified
 * &#064;HeaderParam. The name of the HTTP header to lookup is either the value
 * of the &#064;HeaderParam annotation or, if the annotation value is empty,
 * the name of the injection point (e.g., the field name).
 * </p>
 * <p>
 * If the HTTP header is not present, and the injection point is annotated with
